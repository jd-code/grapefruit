/* 
 * $Id: td.h,v 1.24 2004/05/03 22:02:50 jd Exp $
...
/*
 * $Log: td.h,v $
 * Revision 1.24  2004/05/03 22:02:50  jd
 * big merge for mingw/msys and cross-mingw
 *
 * Revision 1.23  2004/03/14 00:24:55  jd
 * documentation updates
 *
 * Revision 1.22  2004/03/03 23:02:53  jd
 * some docs
 *
 * Revision 1.21  2004/03/01 18:05:02  jd
 * corrected "pure virtual method called" bug (paradigm : never call a virtual function in destructors)
 *
 * Revision 1.20  2004/02/28 15:38:49  jd
 * documentations updates
 *
 * Revision 1.19  2004/02/21 15:04:35  jd
 * better error handling in doit+clean systems
 *
 * Revision 1.18  2004/02/19 00:39:12  jd
 * added automated z-location management
 *
 * Revision 1.17  2004/02/13 14:07:40  jd
 * moved from inheriting Actions to being enriched with Action-derivated members instead...
 *
 * Revision 1.16  2004/01/31 15:59:17  jd
 * introduction of TDObjHideable TDObjShowable
 *
 * Revision 1.15  2004/01/20 15:40:02  jd
 * massive librarization around menu, stdstrings etc
 *
 * Revision 1.14  2004/01/13 23:49:02  jd
 * corrected TDCompound desactivation's crash bug
 *
 * Revision 1.13  2004/01/09 17:25:13  jd
 * *** empty log message ***
 *
 * Revision 1.12  2003/11/28 14:37:08  cristelle
 * changed tdobj list to public in TDCompound as it is needed for menus
 *
 * Revision 1.11  2003/10/24 21:36:09  jd
 * ultimate cleaning for double checking compound members destroyin-process
 *
 * Revision 1.10  2003/10/24 20:57:04  jd
 * librarization of TDCompound
 * debugging of TDObj hide and desactivate
 *
 * Revision 1.9  2003/10/23 13:48:58  cristelle
 * TDObj has been tuned for TDCompound
 *
 * Revision 1.8  2003/10/20 13:30:05  jd
 * added TD size related methods
 * numerous TDs updates
 *
 * Revision 1.7  2003/10/13 14:56:07  jd
 * *** empty log message ***
 *
 * Revision 1.6  2003/09/29 22:28:37  jd
 ...
 *
 * Revision 1.4  2003/09/17 20:56:59  jd
