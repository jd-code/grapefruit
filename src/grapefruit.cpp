...
/*
 * $Log: grapefruit.cpp,v $
 * Revision 1.10  2003/09/25 13:15:04  jd
 * small tunings with grabbing and TDs
 *
 * Revision 1.9  2003/09/18 14:35:55  jd
 ...
 *
 * Revision 1.6  2003/08/06 19:44:49  jd
 * *** empty log message ***
 *
 * Revision 1.5  2003/06/26 13:56:52  jd
 * added first raw method Text
 *
 * Revision 1.4  2003/06/04 22:41:52  jd
 * enabled some close buttons for agrume
 *
 * Revision 1.3  2003/05/20 21:40:27  jd
 * added RadioValue/RadioButton (from testrans)
 *
 * Revision 1.2  2003/05/15 22:46:20  jd
 * tuned shadow generation in currant
 * added valuechange virtual member for Buttons
 *
 * Revision 1.1.1.1  2003/04/22 14:04:34  jd
 * librarisation of grapfruit
 *
 * Revision 1.9  2003/04/19 14:58:59  jd
 * first set of cleaning
 *
 * Revision 1.8  2003/04/19 14:31:57  jd
 * last debugging of grapefruit before cleaning
 *
 * Revision 1.7  2003/04/18 23:40:28  jd
 * moved Currant to a derivation of ButtonStyle, still buggy
 *
 * Revision 1.6  2003/04/11 22:57:32  jd
 * miscs about gcc 2.95 -> 3.2
 * clipping added in various graphical primitives (to be enhanced in polyxxx)
 * agrume extensions
 *
 * Revision 1.5  2003/04/09 23:43:23  jd
 * added CaptioZone
 *
 * Revision 1.4  2003/04/08 23:02:36  jd
 * agrume enhancements
 *
 * Revision 1.3  2003/04/03 00:01:03  jd
 * Agrumes adjustments
 *
 * Revision 1.2  2003/04/02 14:15:46  jd
 * addition of Agrume
 *
 ...
 * first texture
 *
 * Revision 1.10  2003/03/20 17:24:10  jd
 * more correction on RotButton
 *
 * Revision 1.9  2003/03/18 23:25:10  jd
 * first attempt of RotButton
 *
 * Revision 1.8  2003/02/27 23:42:06  jd
 * nested the grapefruit part into the eponyme namespace
 * partially commented for doxygen
 * added the Currant object for splitting rendering from other functionalities
 *
 * Revision 1.7  2003/02/15 00:04:31  jd
 * cleaning in regard with gcc-3.2
 *
 * Revision 1.6  2003/02/13 22:36:10  jd
 * added handling of mouse entering and leaving control's area
 *
 * Revision 1.5  2003/02/12 23:58:32  jd
 * added copy of underlying of buttons
 *
 * Revision 1.4  2003/02/12 17:17:39  jd
 * dirty ci for first transparent buttons
 *
 * Revision 1.3  2003/02/08 00:36:08  cristelle
 * added OnePressbutton
 * changed to stupid colors
 * next and continuous buttons are now (nearly) fully working thanks to JD who did the seq flush
 *
 * Revision 1.2  2003/02/07 23:30:00  jd
 * augmented shadows
 *
 * Revision 1.1  2003/02/06 00:36:54  jd
